...
if __name__ == '__main__':
    ...
    # eyulush: set category to remove warning
    print(categories)
    print(order_train.keys())
    for cf in categories:
        order_train[cf] = order_train[cf].astype('category')
        order_test[cf] = order_test[cf].astype('category')
    # end

    print('not included', set(order_train.columns.tolist()) - set(features))

    # eyulush: order_train and order_test is data for training and submission
    ...
    # eyulush : save the data for future
    print('training and prediction is done')
    #order_train.dtypes.to_pickle('data/lgb_order_train.dtype')
    #order_train.to_csv('data/lgb_order_train.csv.gz', compression='gzip', index=False)

    #order_test.dtypes.to_pickle('data/lgb_order_test.dtype')
    #order_test.to_csv('data/lgb_order_test.csv.gz', compression='gzip', index=False)
